...
def calcCO2Values(data: pd.DataFrame):
...
def calcTemperatureValues(data: pd.DataFrame):
    pass

def calcValues(quantity: str, data: pd.DataFrame):
...
for chunk in dataCollection.dataChunks:
    calcCO2Values(chunk.dataSeries)
